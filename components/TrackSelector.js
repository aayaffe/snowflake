          ...
          <tr>
            {trackIds.map(trackId => (
              <td key={trackId} className="track-selector-value"
                  style={{color: 'white', border: '4px solid ' + (trackId == this.props.focusedTrackId ? '#848b79': categoryColorScale(tracks[trackId].category)), background: categoryColorScale(tracks[trackId].category)}}
